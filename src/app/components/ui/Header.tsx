      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <a href="#top" className="flex items-center gap-3 hover:opacity-80 transition-opacity duration-200 cursor-pointer">
            ...
            <div className="flex items-center gap-2 ml-2">
              <a 
                href="https://www.linkedin.com/in/eduardo-gillung-873a72199/" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/EduardoGillung" 
                target="_blank" 
                rel="noopener noreferrer"
