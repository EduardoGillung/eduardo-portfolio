    ...
    <section id="about" className="pt-24 md:pt-32 pb-16" aria-labelledby="about-heading">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <ContentCard className="w-full">
          ...
          {/* Layout com duas colunas: conteúdo à esquerda e Globe à direita */}
          <div className="flex flex-col lg:flex-row gap-12 mt-12">
            ...
            {/* Coluna direita - Globe */}
            <div className="lg:w-96 h-96 relative flex items-start justify-center lg:mt-24">
